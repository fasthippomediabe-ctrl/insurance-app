...
const navItems = [
  {
    ...
    roles: ["ADMIN", "BRANCH_STAFF", "HR", "ACCOUNTING", "COLLECTION_HEAD", "COLLECTION_SUPERVISOR"],
  },
  {
    label: "Employees",
    href: "/employees",
    ...
    roles: ["ADMIN", "BRANCH_STAFF", "HR", "ACCOUNTING"],
  },
  {
    label: "Members",
    href: "/members",
  ...
  },
  {
    ...
    roles: ["ADMIN", "HR", "ACCOUNTING", "COLLECTION_HEAD"],
  },
  {
    label: "Claims",
    href: "/claims",
      ...
      <div className="px-4 py-3 border-t" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold"
          ...
          {role === "ADMIN" ? "Administrator"
            ...
            : role === "COLLECTION_HEAD" ? "Collection Head"
            : role === "COLLECTION_SUPERVISOR" ? "Collection Supervisor"
            : "Branch Staff"}
        </span>
      </div>
    </div>
