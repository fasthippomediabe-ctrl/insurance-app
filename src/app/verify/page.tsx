      ...
      <div className="max-w-lg mx-auto px-4 pb-12">
        ...
        {data && (
          <div className="space-y-4">
            ...
            {/* Disclaimer + Contact */}
            <div className="bg-white/10 rounded-xl px-4 py-4 text-xs text-white/70 text-center space-y-2">
              <p>If you find any discrepancies, please visit your branch office or contact us. We are updating records from our system migration.</p>
              <a href="https://facebook.com/TripleJCares" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 px-4 py-2 rounded-full text-white font-medium transition-colors">
        ...
        <div className="text-center mt-8 text-xs text-white/40">
          ...
          <p className="mt-1">For concerns, visit your branch office or message us on <a href="https://facebook.com/TripleJCares" target="_blank" rel="noopener noreferrer" className="text-white/60 underline">Facebook</a>.</p>
        </div>
      </div>
    </div>
  );
